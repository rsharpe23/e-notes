...
В Си доступны следующие директивы:
 ...
 #if - начало условия;
 #else - задает альтернативу для условия;
...
Обычно, она вставляет текст из какого-то заголовочного файла. Заголовочные файлы содержат прототипы ф-ций, объявления переменных и констант, и имеют расширение .h
